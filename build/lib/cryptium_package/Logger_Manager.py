...
class LoggerManager:
    ...
    def __init__(self, config):
        ...
        info_log_file = self.config_data.get('log_files', {}).get('Info_log', 'Cryptium_Info_Logs.log')
        error_log_file = self.config_data.get('log_files', {}).get('Error_log', 'Cryptium_Error_Logs.log')
