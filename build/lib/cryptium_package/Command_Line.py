...
def parse_cli_arguments():
    ...
    sort_parser.add_argument("--folderpath", type=str, help="Specify the path of the folder to be sorted.")
    ...
    unsort_parser.add_argument("--folderpath", type=str, help="Specify the path of the folder to be unsorted.")
